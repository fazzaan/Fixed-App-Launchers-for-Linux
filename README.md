...
Lately there are so many apps failing to run.
...
If you're just a regular user like me, you probably just want things to work.

This repo is to contain the app launcher fixes that I've written for myself, based on scraping together solutions from people around the web, forums, reddit, matrix, etc.
...
The fixes are things like .desktop files and launch env commands,
...
For the ones which are just shell commands, I'll put them right here in the readme.  
